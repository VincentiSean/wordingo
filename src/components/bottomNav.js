...
const BottomNav = ({ page, user }) => {
    ...
    return (
        <div className="nav-wrapper">
            <button className="nav-btn" name="home" onClick={() => handleClick("home")}>
            ...
            <button className="nav-btn" name="create" onClick={() => handleClick("create")}>
            ...
            <button className="nav-btn" name="create" onClick={() => handleClick("account")}>
